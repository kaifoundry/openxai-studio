...
export default function Home() {
  ...
  return (
    <motion.div
      className="grid size-full grid-cols-1 lg:grid-cols-[3fr_1fr]  "
      ...
      <div className="flex flex-col gap-8 px-4 py-8 sm:gap-16 sm:px-8 md:gap-24 md:px-12 lg:gap-24 lg:px-16">
        <div className="mt-8 sm:mt-16 lg:mt-24 ">
          ...
          <div className="mt-6 flex flex-row gap-3 sm:mt-8 sm:flex-row sm:items-center sm:gap-4 lg:mt-12">
            <Link
              href="/app-store"
              className="flex h-12 items-center justify-center rounded-full bg-primary px-8 text-lg font-medium text-background transition-colors hover:bg-primary/90 sm:h-14 sm:px-10 lg:px-12 lg:text-xl"
            >
              Build Now
            </Link>
            <Link
        ...
        <div className="grid grid-cols-2  lg:grid-cols-4 w-full  lg:w-full 3xl:w-[80%] gap-4 lg:gap-0 py-4 lg:py-0 ">
          ...
          <div className="flex justify-center items-center  lg:border-r-2 border-gray-300 py-2   px-5">
            <div className="flex flex-col   ">
              <div className="flex  justify-center ">
                <span className="text-2xl font-medium lg:text-3xl 3xl:text-4xl">600</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-between lg:justify-start   items-center w-full 2xl:w-[80%]  3xl:w-[60%] pb-10">
          <div className="flex justify-start items-center border-gray-300 pb-6   border-b-2 lg:border-b-0 lg:border-r-2  ">
            <div className="flex justify-between lg:place-items-center gap-2 w-full   lg:gap-6">
              <div>
                <ChartContainer
                  config={{
                    data: {
