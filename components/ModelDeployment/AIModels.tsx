...
const AIModels = ({Modelid,selectedModel,onSelectOption}:AIModelsProps) => {
    ...
    <div className="grid grid-cols-3 gap-4">
              ...
              <div
                ...
                className=
                  {`flex h-[128px] cursor-pointer flex-col rounded-lg border p-6 hover:border-primary/50 max-[1550px]:h-[120px] max-[1550px]:p-5 max-[1350px]:h-[112px] max-[1350px]:p-4 max-[1250px]:h-[100px] max-[1250px]:p-3 max-[992px]:h-[90px] max-[992px]:p-2
                    ${selectedModel?.name === size.name ?"border-primary bg-primary/5" : ""}
                    `}
              >
      ...
      <div className="text-lg font-medium max-[1550px]:text-base max-[1350px]:text-sm max-[1250px]:text-xs max-[992px]:text-[10px]">{size.name}</div>
                  ...
                  <div className='flex gap-3'>
                    <Image src={modelDefinition.image} alt='' width={30} height={30} />
                    <div className="text-[10px] 2xl:text-[15px] 3xl:text-[15.94px] font-[500]">
                ...
                <div className="flex justify-between gap-4 max-[1550px]:gap-3.5 max-[1350px]:gap-3 max-[1250px]:gap-2.5 max-[992px]:gap-2">
                  <div className="max-[1550px]:gap-1.75 max-[992px]:gap-0.75 flex items-center gap-1 max-[1350px]:gap-1.5 max-[1250px]:gap-1">
                    ...
                    <div>
                      ...
                      <div className="text-sm max-[1550px]:text-xs max-[1350px]:text-[11px] max-[1250px]:text-[10px] max-[992px]:text-[9px] font-[500]">{size.ram}</div>
                    </div>
                  </div>
                  ...
                  <div className="max-[1550px]:gap-1.75 max-[992px]:gap-0.75 flex items-center gap-1 max-[1350px]:gap-1.5 max-[1250px]:gap-1">
                    ...
                    <div>
                      ...
                      <div className="text-sm max-[1550px]:text-xs max-[1350px]:text-[11px] max-[1250px]:text-[10px] max-[992px]:text-[9px] font-[500]">{size.storage} SSD</div>
                    </div>
                  </div>
                  ...
                  <div className="max-[1550px]:gap-1.75 max-[992px]:gap-0.75 flex items-center gap-1 max-[1350px]:gap-1.5 max-[1250px]:gap-1">
                    ...
                    <div>
                      ...
                      <div className="text-sm max-[1550px]:text-xs max-[1350px]:text-[11px] max-[1250px]:text-[10px] max-[992px]:text-[9px] font-[500]">{size.cpu}</div>
                    </div>
                  </div>
                </div>
              </div>
